...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(593, 264)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.IrisWidget = QtWidgets.QWidget(self.centralwidget)
        self.IrisWidget.setGeometry(QtCore.QRect(110, -10, 241, 201))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 120, 223, 25))
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.layoutWidget2)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.goToDiameterButton = QtWidgets.QPushButton(self.layoutWidget2)
        self.goToDiameterButton.setObjectName("goToDiameterButton")
        self.horizontalLayout.addWidget(self.goToDiameterButton)
        self.goToDiameterEntry = QtWidgets.QLineEdit(self.layoutWidget2)
        ...
        self.IrisWidget_2.setGeometry(QtCore.QRect(350, -10, 241, 201))
        ...
        self.fireButton.setGeometry(QtCore.QRect(120, 200, 461, 23))
        self.fireButton.setObjectName("fireButton")
        self.layoutWidget3 = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 10, 101, 101))
        self.layoutWidget3.setObjectName("layoutWidget3")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget3)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.ComPortLabel = QtWidgets.QLabel(self.layoutWidget3)
        ...
        self.ComPortSelectBox = QtWidgets.QComboBox(self.layoutWidget3)
        self.ComPortSelectBox.setObjectName("ComPortSelectBox")
        self.verticalLayout.addWidget(self.ComPortSelectBox)
        self.comPortConnectButton = QtWidgets.QPushButton(self.layoutWidget3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.iris1label.setText(_translate("MainWindow", "Iris 1"))
