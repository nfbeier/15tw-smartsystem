...
from devices.NewportPicomotor.MultiMirrorControl_App import MultiMirrorControl_App
...
if __name__ == '__main__':
    ...
    main_window.setWindowTitle("Alignment-inator 9000")
    ...
    pico_gui = MultiMirrorControl_App()
    grid_layout.addWidget(pico_gui, 1, 0)
